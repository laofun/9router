...
describe("request normalization", () => {
  it("claudeToOpenAIRequest preserves text-only content arrays as OpenAI text blocks", () => {
    const body = {
      messages: [
        {
          role: "user",
  ...
  it("claudeToOpenAIRequest returns string for single text block", () => {
    const body = {
      messages: [
        {
          role: "user",
  ...
  it("translateRequest keeps /v1/messages Claude->OpenAI text payloads as text blocks", () => {
    const body = {
  ...
  it("parseSSELine supports provider raw NDJSON stream lines when format is ollama", () => {
